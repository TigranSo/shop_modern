...
class Product(models.Model):
    class TypeMis(models.TextChoices):
        ...
        XUDI = 'Худи', ('Худи')
        SVITER = 'Свитера', ('Свитера')
        ZHAKETI = 'Жакеты', ('Жакеты')
        VETROVKI = 'Ветровки', ('Ветровки')
        KURTKI = 'Куртки', ('Куртки')
        PUXOVIKI = 'Пуховики', ('Пуховики')

    name = models.CharField(max_length=255, verbose_name='Наименование товара')
    type_mis = models.CharField(max_length=50,choices=TypeMis.choices, default=TypeMis.KOST, verbose_name='Вид товара')
    ...
    Discount = models.DecimalField(max_digits=20, decimal_places=0, verbose_name='Скидка в %')
